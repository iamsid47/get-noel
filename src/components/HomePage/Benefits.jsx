...
const features = [
  {
    name: "Available 24/7",
    description:
      "Noel is available 24/7, which means you can get the support you need at any time of the day or night, even outside of regular business hours.",
    icon: ChatBubbleBottomCenterIcon,
  },
  {
    name: "Instant Response",
    description:
      "With Noel, you can get instant responses to your queries, without having to wait on hold or for a support rep to get back to you. This can save you time and make the support process more efficient.",
    icon: BoltIcon,
  },
  {
  ...
  },
  {
    name: "Cost Effective",
    description:
      "Since Noel is an AI-powered chatbot, we can provide support to customers at a lower cost than we could with a team of support reps.",
